...
> **Décision actée** : [`0002 — Hébergement sur Coolify`](decisions/0002-hebergement-sur-coolify.md).
...
> **Décision actée** : [`0003 — Dashboard : un seul environnement, production`](decisions/0003-dashboard-un-seul-environnement.md).
